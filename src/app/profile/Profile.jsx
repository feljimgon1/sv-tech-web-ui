        ...
        <>
          ...
          <div className='companies-list'>
            {companies.map((company, index) => {
              return (
                <Card key={index} sx={{ maxWidth: 345 }} className="company">
                  {company.logo ? (
                    <CardMedia
                      component="img"
                      alt={company.name}
  ...
  return (
    <div className='profile-container'>
      ...
      <div className="content">
        {activeSection === 'companies-section' && renderCompanies()}
      ...
      </div>
      {
        ...
        <AddCompanyModal open={isAddCompanyModalOpen} onClose={() => setIsAddCompanyModalOpen(false)} />
      }
    </div>
  );
}
